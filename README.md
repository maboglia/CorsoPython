...
- **Python 3.10+** (scaricabile da [python.org](https://www.python.org/downloads/))  
...
Questo corso è distribuito sotto licenza **MIT**.
Puoi usarlo liberamente per scopi didattici o personali, citando la fonte.
